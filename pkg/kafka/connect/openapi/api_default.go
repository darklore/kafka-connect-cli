...
func (r ApiGetConnectorActiveTopicsRequest) Execute() (*map[string]ConnectorActiveTopicsValue, *http.Response, error) {
...
func (a *DefaultAPIService) GetConnectorActiveTopicsExecute(r ApiGetConnectorActiveTopicsRequest) (*map[string]ConnectorActiveTopicsValue, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *map[string]ConnectorActiveTopicsValue
	)
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		newErr := &GenericOpenAPIError{
			...
			var v map[string]ConnectorActiveTopicsValue
			err = a.client.decode(&v, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHTTPResponse, newErr
